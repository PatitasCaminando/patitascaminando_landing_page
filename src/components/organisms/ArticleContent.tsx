...
export const ArticleContent: React.FC<any> = () => {
  ...
  return (
    <section className="pb-32 md:pb-40 lg:pb-48 bg-white relative overflow-x-clip pt-8">
      {/* Separador Pilares */}
      <div className="w-full flex justify-center mb-16 md:mb-24 opacity-50 pointer-events-none select-none overflow-hidden">
        <img
          src={doodlePilaresSeparador.src}
          alt=""
          aria-hidden="true"
          className="w-[300px] sm:w-[500px] md:w-[600px] lg:w-[800px] xl:w-[1000px] max-w-none object-contain"
        />
      </div>
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute -bottom-10 md:-bottom-16 lg:-bottom-24 -left-4 md:-left-8 lg:-left-12 w-32 sm:w-56 md:w-80 lg:w-[450px] pointer-events-none select-none z-0"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute -bottom-10 md:-bottom-16 lg:-bottom-24 -right-4 md:-right-8 lg:-right-12 w-32 sm:w-56 md:w-80 lg:w-[450px] pointer-events-none select-none z-0"
      />
